...
class DataProcessor:
    ...
    def select_features(self, df):
        try:
            ...
            top_imp_df = feature_importance_df.sort_values(
                by="importance", ascending=False
            )
            num_features_to_select = self.config["data_processing"]["no_of_features"]
            top_10_features = top_imp_df["feature"].head(num_features_to_select).values
            ...
            raise CustomException(f"Error while faeture selection", e)
