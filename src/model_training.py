...
class ModelTraining:
    ...
    def __init__(self, train_path, test_path, model_output_path):
        ...
        self.params_distribution = LTGM_PARAMS
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Logging model and params in mlflow")
            ...
            logger.error(f"Error while Training model pipeline {e}")
            raise CustomException("Failed during Training model pipeline", e)
